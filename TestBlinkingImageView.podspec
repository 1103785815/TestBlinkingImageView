#
# Be sure to run `pod lib lint TestBlinkingImageView.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'TestBlinkingImageView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TestBlinkingImageView' => ['TestBlinkingImageView/Assets/*.png']
  # }
